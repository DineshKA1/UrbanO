...
import com.androiddevs.runningapp.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setUpBottomNavigationBar() {
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                R.id.urbanHome, R.id.urbanSess, R.id.urbanProfile)
                .build();
        navController = Navigation.findNavController(this, R.id.nav_host_fragment_activity_main);
        NavigationUI.setupActionBarWithNavController(this, navController, appBarConfiguration);
        NavigationUI.setupWithNavController(mBinding.urbanNavview, navController);
    ...
    private void signOut() {
        final Intent loginIntent = new Intent(this, StartActivity.class);
